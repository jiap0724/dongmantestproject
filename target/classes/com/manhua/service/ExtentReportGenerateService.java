...
public class ExtentReportGenerateService implements IReporter {
	...
	// System.getProperty("user.dir")+"\\TestOutput\\ExtentReport\\";
	private static final String OUTPUT_FOLDER = "/Users/jiapeng/Downloads/Appium/test-output/ExtentReport/";
    /**
     * 报告的名称
     */
...
//        String a =suite.getName();
        ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(OUTPUT_FOLDER + FILE_NAME);
			htmlReporter.config().setDocumentTitle("微博动漫测试报告");
...
//                	String fileName = result.getMethod().getMethodName() + ".png";
                	try {
						...
						String AppointDir = "/test-output/ExtentReport/BugScreenshot/";
